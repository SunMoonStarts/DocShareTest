			...
			<div class="card-wrapper">
				...
				<div class="card fat">
					<div class="card-body">
						...
						<form method="POST" action="userAction!login.action?type=admin">

							<div class="form-group">
								<label for="username">用户名</label> <input id="username"
									type="text" class="form-control" name="user.user_name" value=""
									required autofocus>
							</div>
							<div class="form-group">
								<label for="password">密码 <a href="forgot.html"
									...
									name="user.user_pwd" required data-eye>
							</div>
							...
							<div class="margin-top20 text-center">
								Don't have an account? <a href="skipUser!skipPage.action?type=register">Create One</a>
							</div>
						</form>
					</div>
				</div>
